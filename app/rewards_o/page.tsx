...
export default function RewardsPage() {
  ...
  {rewards.filter(reward => reward.name === "Your Points").length > 0 ? (
    rewards
      .filter(reward => reward.name  === "Your Points")
      .map(reward => (
        <div key={reward.id} className="bg-white p-4 rounded-xl shadow-md">
          ...
          <p className="text-gray-600 mb-2">Use your points to report more tasks</p>
          <p className="text-sm text-gray-500 mb-4">Points will be awarded periodically based on your organization's performance and engagement</p>
